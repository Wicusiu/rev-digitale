 ...
 */
export declare type Operators = 'eq' | 'neq' | 'gt' | 'gte' | 'lt' | 'lte' | 'inq' | 'between' | 'exists' | 'and' | 'or' | 'like' | 'nlike' | 'ilike' | 'nilike' | 'regexp';
/**
 ...
 * ```
 */
export declare type Where<MT extends object = AnyObject> = Condition<MT> & Partial<AndClause<MT>> & Partial<OrClause<MT>>;
/**
 * And clause
 * For example:
 * ```ts
